...
Intuitively, because the electrons put most of the energies in the front of the detector, they will have the bigger value for $E_{10}$. Oppositely, for the e-like pions, because they put all of the energies in the different sections, they will have many values for $E_{10}$ from all events. In the Fig.\ref{}, we can see that we can use $E_{10}$ to reject some of e-like pion out of the electron region. 
