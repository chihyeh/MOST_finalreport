...
\begin{table}[h]%??table???????????????????[h]???????here?????????????
    ...
    E7/E19 & $>$ 0.75\\\hline  
        \end{tabular}
    \caption{E10/Etotal Tight cuts selection}\label{basic_1}  %????????????
\end{table}
...
\end{equation}
\begin{equation}
\mathrm{Background \ Rejection \ = \frac{Total \ e-like \ pions}{Pass \ e-like \ pions}}
\end{equation}
...
First, we tried to use the critical point at 0.2, 0.3 and 0.4, and see whether it can give us the best results. In the Table.\ref{basic_1}}, it tells us that the background rejection is good, but we hoped that our electron efficiency will go to 99.8\% also and won't drop after the higher critical point, later we tried to use the point near 0.2 and see whether we can get the great results without losing more electrons. In the Table.\ref{basic_2}, it said that near the point 0.2, it can reserve most of the electrons near 99.9\% and can get the background rejection with the expectation value near 2. 
\begin{table}[h]%??table???????????????????[h]???????here?????????????
    \centering
    \begin{tabular}{|l|c|c|}
    \hline
    ...
    \end{tabular}
    \caption{E10/Etotal cuts background rejection vs. Electrons Efficiency with true values}\label{basic_1}  %????????????
\end{table}
...
\begin{table}[h]%??table???????????????????[h]???????here?????????????
    ...
    \end{tabular}
    \caption{E10/Etotal cuts background rejection vs. Electrons efficiency with true values}\label{basic_2}  %????????????
\end{table}
